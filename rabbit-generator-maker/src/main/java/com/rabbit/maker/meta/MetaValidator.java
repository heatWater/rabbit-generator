...
import com.rabbit.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "rabbit");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.rabbit");
        String version = StrUtil.emptyToDefault(meta.getCreateTime(), DateUtil.now());
