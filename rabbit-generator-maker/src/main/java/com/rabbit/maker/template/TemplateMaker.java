...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String sourceRootPath = new File(projectPath).getParent() + File.separator + "rabbit-generator-demo-projects/acm-template";
        // 注意 win 系统需要对路径进行转义
        sourceRootPath = sourceRootPath.replaceAll("\\\\", "/");

        String fileInputPath = "src/com/rabbit/acm/MainTemplate.java";
